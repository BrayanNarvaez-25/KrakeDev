 ...
 */
    ...
    */
    if (esProductoValido(nombreProducto, "lblError1") && esCantidadValida(cantidad, "lblError2") && esPrecioValido(precioProducto, "lblError3")) {
        ...
        mostrarTexto("lblResumen", "Valor a pagar por " + cantidad + " " + nombreProducto + " con el " + valorDescuento + "% de descuento es: USD " + valorTotal);
    }else{
...
limpiar = function () {
    ...
    cmpTxtCaja = document.getElementById("lblError1");
    cmpTxtCaja.innerText = "";

    cmpTxtCaja = document.getElementById("lblError2");
    cmpTxtCaja.innerText = "";

    cmpTxtCaja = document.getElementById("lblError3");
    cmpTxtCaja.innerText = "";
    /*
